...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_bin", type=str, default="/data/shared/InfiniTrain-dev/data/llmc/gpt2/tinyshakespeare/tiny_shakespeare_train.bin", help="input .bin to train on")
